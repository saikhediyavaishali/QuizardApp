function BlogDetails() {
  return (
    <>
      <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-gray-100 text-gray-800">
        <div className="flex justify-between px-4 mx-auto max-w-screen-2xl ">
          <article className="mx-auto w-full max-w-2xl">
            <header className="mb-4 lg:mb-6 ">
              ...
              <h1 className="mb-4 text-3xl font-extrabold leading-tight lg:mb-6 lg:text-4xl text-gray-900">
            ...
            <p>
              {" "}
              Lets start by including the CSS file inside the <code>
                head
              </code>{" "}
              tag of your HTML.
            </p>
              ...
              <form className="mb-6">
                <div className="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 dark:bg-gray-200 dark:border-gray-700">
                  ...
                  <textarea
                    id="comment"
                    rows="6"
                    className="px-0 w-full text-sm outline-none text-gray-900 border-0 focus:ring-0 dark:text-white dark:placeholder-gray-400 dark:bg-gray-200"
